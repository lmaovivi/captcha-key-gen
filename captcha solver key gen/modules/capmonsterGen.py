...
class GenerateCapSolverKey():
    ...
    def checkKey(self, key):
        try:
            ...
            response = requests.post('https://api.capmonster.cloud/getBalance', json={'clientKey': key}, proxies=proxy).json() 
...
def capmonster():
    ...
    generator._print('--- CapMonster Key Gen ---', colorama.Fore.CYAN)
